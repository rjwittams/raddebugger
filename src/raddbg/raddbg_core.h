...
internal E_TLSVAddrResolution rd_tls_vaddr_from_platform_vaddr(E_Space space, U64 platform_tls_vaddr);
...
internal RD_RegSlot rd_regs_fill_slot_from_ctx_eval(E_Eval eval);
