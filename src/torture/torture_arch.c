...
TEST(arm64_rdi_dwarf_mappings)
{
  ...
  T_Ok(arch_reg_code_from_dw(Arch_arm64, DW_RegCodeARM64_pc) == ARM64_RegCode_pc);
  ...
  T_Ok(rdi_from_reg_code_table[ARM64_RegCode_pc] == RDI_RegCodeARM64_pc);
  T_Ok(dw_from_reg_code_table[ARM64_RegCode_pc] == DW_RegCodeARM64_pc);
