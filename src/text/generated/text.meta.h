...
C_LINKAGE_BEGIN
extern String8 txt_lang_kind_ext_table[9];
extern String8Array txt_keywords_from_lang_kind_table[9];
extern String8Array txt_multichar_symbols_from_lang_kind_table[9];
extern TXT_TokenizerRuleArray txt_tokenizer_rules_from_lang_kind_table[9];
